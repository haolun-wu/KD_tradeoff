...
if __name__ == '__main__':
    ...
    result_table = PrettyTable(['Dataset', 'alpha', 'hidden_units', 'ACC_train', 'ACC_test'])
    for alpha in alpha_list:
        for dnn_hidden_units in dnn_hidden_units_list:
            ...
            result_table.add_row([args.data_name, args.alpha, dnn_hidden_units, train_accuracy, test_accuracy])
