...
def train(args):
    ...
    saved_path = './saved/{}/model_{}/teacher_dim{}_CE.pt'.format(args.data_name, args.model_name, args.dim)
...
if __name__ == '__main__':
    ...
    lr_list = [1e-3]
    wd_list = [1e-5, 1e-3]
    result_table = PrettyTable(['Dataset', 'lr', 'wd', 'hidden_units', 'ACC_train', 'ACC_test'])
        ...
        for dnn_hidden_units in dnn_hidden_units_list:
            for lr in lr_list:
                for wd in wd_list:
                    ...
                    args.lr, args.wd = lr, wd
                    train_accuracy, test_accuracy = train(args)
                    train_accuracy_list.append(train_accuracy)
                    test_accuracy_list.append(test_accuracy)
                    result_table.add_row([data, lr, wd, dnn_hidden_units, train_accuracy, test_accuracy])
