...
if __name__ == '__main__':
    ...
    result_table = PrettyTable(['Dataset', 'lr', 'alpha', 'temp', 'hidden_units', 'ACC_train', 'ACC_test'])
            ...
            for alpha in alpha_list:
                for temp in temp_list:
                    ...
                    result_table.add_row(
                        [args.data_name, args.lr, args.alpha, args.temp, dnn_hidden_units, train_accuracy,
                         test_accuracy])
